<?php
    ...
    if($FLG_ProjectType_Delete  == 0 && $FLG_ProjectType_View== 0 )
    {
        //echo 'step123';
	...
	{
		$Id=$_GET['did'];
		$sql = "Delete from project_type_master where Id=" . $Id;
   ...
   <?php include('sidebar.php')?>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <th>Description</th>                  
                        <th>Remark</th>
                        <?php    if($FLG_ProjectType_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_ProjectType_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                    </tr>
                    </thead>
                    ...
                    <?php
						...
						while($row = mysqli_fetch_array($res))
						{
                            ...
                            if($FLG_ProjectType_Edit==1 )
							echo '<td><a href="Project Type.php?pid=' . $row['Id'] . '" ><i class="fa fa-edit" style=font-size:2.5em;; ></i></a></td>';	
							//echo '<td>' . '<button class="btn btn-primary" type="submit" name="btnSubmit" id="btnSubmit">  Edit </button>' . '</td>';
                            if($FLG_ProjectType_Delete )
    ...
    <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Project_Type_list.php?did=" + tmp;
