	...
	<div class="col-lg-12">
		...
		<div class="ibox float-e-margins">
					<div class="ibox-title">
                        <h5> Project Team Report</h5>
                        	<button class="col-lg-offset-9 btn btn-primary " onClick="deleteconfig(<?php echo $_REQUEST['cmb_project']; ?>);">Download</button>
       ...
       <form id="frmEntry" name="frmEntry" method="post" action="projectteamreport.php">              
...
<!--------------------------------Status Showing-------------------------------------------------------->
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="col-lg-5">  <label></label> </div>
                       <div class="col-lg-offset-11">
                     	<!-- <a href="Task.php">
						  <input type="button" class="btn btn-primary"  name="btnSubmit" id="btnSubmit" value="Update">
						  </a>-->
							</div>
                       <div class="form-group ">
					...
					if(isset($_REQUEST['cmb_project']) && $_REQUEST['cmb_project']<>0)
					{
						
						
						$sql ="Select pm.*, sm.Name as sname from project_master pm, status_master sm";
						if(isset($_REQUEST['cmb_project']) && $_REQUEST['cmb_project']<>0)
						$sql .= " Where pm.Id=" .$_REQUEST['cmb_project'];
						$sql .= " and pm.Status_Id=sm.Id";
						...
						while($row = mysqli_fetch_array($res))
						{
							...
							echo '<td align="right"><a href="project_Entry.php?Pid=' . $row['Id'] . '" ><i class="fa fa-edit " style="font-size:2.5em;"></i></a></td>';	
							echo '</tr>';
						}
					}
...
<!--------------------------------user showing --------------------------------------------------------------------------------------->				<?php if(isset($_REQUEST['cmb_project'])&& $_REQUEST['cmb_project']<>0)
							{
    	...
    	function deleteconfig(id)
    			{
			  	...
			  	window.location.href="projectteamreportPrint.php?pid=" + id;
