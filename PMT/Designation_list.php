<?php
    ...
    if($FLG_Designation_Delete == 0 && $FLG_Designation_View == 0 )
    {
        //echo 'step123';
	...
	{
		$Id=$_GET['did'];
		$sql = "Delete from designation_master where Id=" . $Id;
		...
		<script type="text/javascript">
			...
			window.location.href="Designation_list.php";
</script>
<?php
		}
		else
			?>
		<script type="text/javascript">
			alert("Designation Delete UnSuccessfully");
			window.location.href="Designation_list.php";
</script>
<?php
	}
...
<body>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        <th>Name</th>
                        <th>Remark</th>
                       <?php    if($FLG_Designation_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_Designation_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                    </tr>
                    </thead>
                    ...
                    <?php
						...
						while($row = mysqli_fetch_array($res))
						{
                            ...
                            if($FLG_Designation_Edit==1 )
							echo '<td><a href="Designation.php?Did=' . $row['Id'] . '" ><i class="fa fa-edit " style=font-size:2.5em;></i></a></td>';
                            if($FLG_Designation_Delete==1 )
   ...
   <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Designation_list.php?did=" + tmp;
