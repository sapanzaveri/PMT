...
session_start();
    ...
    $Address="";
						...
						while($row = mysqli_fetch_array($res))
						{
							...
							$Contact = '<td>' . $row['Contact'] . '</td>';
							$SkypeId = '<td>' . $row['Skype_Id'] . '</td>';
                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                               ...
                               <div class="ibox-content no-padding border-left-right col-md-5">
                                ...
                                <!--<div class="row m-t-lg">
                                    <div class="col-md-4">
                                        <h5><span class="bar">About Me</span></h5>
                                        <h4>I am the Admin of the system and Also Developing project on PHP </h4>
                                    </div> -->                        
                                <div class="row m-t-lg">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <h5><span class="line">Contact No.</span></h5>
                                        <h4><strong><?php echo $Contact;?></strong></h4>
                                    </div>
                                    <div class="col-md-4">
                                        <h5><span class="bar"> Skype Id</span></h5>
                                        <h4><strong><?php echo $SkypeId;?></strong></h4>
                                    </div>
