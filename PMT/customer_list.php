<?php
    ...
    if($FLG_CUSTOMER_Delete == 0 && $FLG_CUSTOMER_VIEW == 0 )
    {
        //echo 'step123';
     ...
     <div id="right-sidebar">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <button class="col-lg-offset-9 btn btn-primary" onclick="window.location.href='CustomerReport.php'">Download Report</button>
                    ...
                    <tr>
                        ...
                        <th>Contact</th>
                        <th>Remark</th>
                        <?php    if($FLG_CUSTOMER_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_CUSTOMER_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                    </tr>
                    </thead>
