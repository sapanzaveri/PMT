...
{
	$Id = $_GET['pid'];
	$sql="Select t.*, s.Name as stname, d.Name as desi, p.Name as pname , sm.Name as  sname";
	$sql .="  from team t, staff_master s, designation_master d, ";
	$sql .=" project_master p, status_master sm ";
...
<body>
    <form method="get" action="projectteamreportPrint.php">
    <div id="wrapper">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>        
                        <?php echo '<tr>';
						echo '<td colspan="3" style="text-align: center">' . $row['pname'] . '</td>';
                        echo '</tr>'; ?>
                        </tbody>
                        <thead>
                         <tr>
                        ...
                        <?php 
						echo '<tr >';
						echo '<td colspan="3" style="text-align: center">' . $row['sname'] . '</td>';
                        echo '</tr>'; ?>
                        </tbody>
                        <thead>
                                 <tr>
        ...
        $(document).ready(function()
		{
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Project Team Report'},
                    {extend: 'pdf', title: 'Project Team Report'},
