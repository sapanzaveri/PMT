<?php
 ...
 include("Role_Prev.php");
    if($FLG_Task_Delete  == 0 && $FLG_Task_View  == 0 )
    {
        //echo 'step123';
	...
	{
		$Id=$_GET['did'];
		$sql = "Delete from task_type_master where Id=" . $Id;
...
<?php
			...
			?>
		<script type="text/javascript">
			alert("Task Delete UnSuccessfully");
			window.location.href="task_list.php";
</script>
<?php
	}
...
<body>
   ...
   <?php include('sidebar.php')?>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        <th>Task_Name</th>
						<th>Remark</th>
                         <?php    if($FLG_Task_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_Task_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
						$sql = "SElect * from task_type_master";
						...
						while($row = mysqli_fetch_array($res))
						{
							...
							echo '<td>' . $row['Remark'] . '</td>';
				            	...
				            	if($FLG_Task_Edit==1 )
							echo '<td><a href="task_entry.php?tid=' . $row['Id'] . '" ><i class="fa fa-edit "style=font-size:2.5em;></i></a></td>';	
								if($FLG_Task_Delete==1 )
    ...
    function deleteconfig(tmp)
    {
      ...
      if (x==true)
		  {
			  window.location="task_list.php?did=" + tmp;
