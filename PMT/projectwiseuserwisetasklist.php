       ...
       <div class="wrapper wrapper-content animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
						    ...
						    <form method="post" action="projectwiseuserwisetasklist.php" class="form-horizontal" id="frmEntry" name="frmEntry">
                        <div class="ibox-title">
							...
							<?php
								...
								$sql="Select t.*,d.Name as Desi,s.Name as Stf, s.Id as sid from team t,staff_master s,designation_master d ";
								...
								if(isset($_REQUEST['cmbstaff']) && $_REQUEST['cmbstaff']==$row4['sid'])
									echo ' selected="Selected" ';
								echo '>' . $row4['Stf'] ."-" . $row4['Desi'] . '</option>';
									//echo '<option value="' . $row4['sid'] . '" >' . $row4['Stf'] . ' - ' . $row4['Desi'] . '</option>';
								}
                ...
                <div class="ibox float-e-margins">
					...
					if(isset($_REQUEST['cmbstaff'])&& $_REQUEST['cmbstaff']<>0)
					{
						...
						$sql .= " and tm.Task_Type_Id = ttm.Id";
