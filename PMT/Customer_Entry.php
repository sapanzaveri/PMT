<?php
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if($hdnId==0)
		{
		$sql = "INSERT INTO `customer_master`(`Name`, `Email`, `Contact_No`, `Remark`) VALUES ('$Name','$Email',$Phone,'$Remark')";
                ...
                <div class="col-lg-12         ">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="Customer_Entry.php">
                               <?php echo $message; ?>
                               <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
                                <div class="form-group"><label class="col-sm-2 control-label">Customer Name</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="txt_name" name="txt_name" placeholder="Enter Name"  required oninvalid="this.setCustomValidity('Enter Proper Name ')"  onchange="this.setCustomValidity('')"
                                    pattern="[a-z A-Z]+" value="<?php if($Id<>0) echo $row['Name']; ?>"></div>
                                </div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Email</label> 

                                    <div class="col-sm-10"><input type="EMail" class="form-control" id="txt_email" name="txt_email" placeholder="Enter Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  required="" value="<?php if($Id<>0) echo $row['Email']; ?>"></div>
                                </div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Phone No</label>

                                   <div class="col-sm-10"><input type="text" class="form-control" id="txt_phone" name="txt_phone" placeholder="Enter Phone Number" required oninvalid="this.setCustomValidity('Enter proper number')"  onchange="this.setCustomValidity('')" min="10" value="<?php if($Id<>0) echo $row['Contact_No']; ?>">
                                   </div>
                                </div>
