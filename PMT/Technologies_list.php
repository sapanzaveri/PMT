<?php
    ...
    if($FLG_Technology_Delete == 0 && $FLG_Technology_View == 0 )
    {
        //echo 'step123';
	...
	if(isset($_GET['did']))
	{
		...
		<script type="text/javascript">
			alert("Technologies Delete Successfully");
			window.location.href="Technologies_list.php";
</script>
<?php
		}
		else
			?>
		<script type="text/javascript">
			alert("Technologies Delete UnSuccessfully");
			window.location.href="Technologies_list.php";
</script>
<?php
     ...
     <div id="right-sidebar">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <?php    if($FLG_Technology_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_Technology_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                        </tr>
                    </thead>
                    ...
                    <?php
						...
						while($row = mysqli_fetch_array($res))
						{
                            ...
                            if($FLG_Technology_Edit==1 )
							echo '<td><a href="Technologies.php?tid=' . $row['id'] . '" ><i class="fa fa-edit large" style=font-size:2.5em;></i></a></td>';
                            if($FLG_Technology_Delete==1 )
  	...
  	<script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Technologies_list.php?did=" + tmp;
