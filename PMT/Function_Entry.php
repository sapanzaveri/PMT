<?php
	...
	if(isset($_POST['btnSubmit']))
	{
        ...
        $sql ="INSERT INTO `function_master`(`Name`, `Remark`) VALUES ('$Name','$Remark')";
...
<?php
		...
		else
        {
          ?>
<script type="text/javascript">
			alert("Function Already Available");
			window.location.href="Function_Entry.php";
</script>
<?php
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Function Entry</h5>
                            
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="Function_Entry.php">
                               <?php echo $message; ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Name</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="txt_name" name="txt_name" placeholder="Enter Name" required oninvalid="this.setCustomValidity('Enter Status Name  ')"  onchange="this.setCustomValidity('')" ></div>
								</div>
