<?php
    ...
    if($FLG_Status_Delete == 0 && $FLG_Status_View == 0 )
    {
        //echo 'step123';
	...
	if(isset($_GET['did']))
	{
		...
		<script type="text/javascript">
			...
			window.location.href="Status_list.php";
</script>
<?php
		}
		else
...
<head>
    ...
    <title>Poject/Task Status list</title>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        <th>Name</th>
              			 <th>Remark</th>
                       <th>Isvisible</th>
                        <?php    if($FLG_Status_Edit==1 )
                                    echo '<th>Edit</th>';
                            if($FLG_Status_Delete == 1  )
                                    echo '<th>Delete</th>';
                        ?>
                        </tr>
                    </thead>
                    ...
                    <?php
						...
						while($row = mysqli_fetch_array($res))
						{
							...
							if($row['Isvisible']==1)
								...
								echo '<td>False</td>';
				            if($FLG_Status_Edit==1 )
							echo '<td><a href="Status_Entry.php?sid=' . $row['Id'] . '" ><i class="fa fa-edit " style=font-size:2.5em;></i></a></td>';
...
<script type="text/javascript">
    function deleteconfig(tmp)
    {
      ...
      if (x==true)
		  {
			  window.location="Status_list.php?did=" + tmp;
