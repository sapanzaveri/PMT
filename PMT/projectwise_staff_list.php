...
<head>
    ...
    <title>Projectwise Staff list</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
							<h5><strong>Projectwise Staff List</strong></h5>
                            
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="projectwise_staff_list.php" id="frmEntry" name="frmEntry">
                     			
                                <div class="form-group"><label class="col-md-2 col-md-offset-3 control-label"><strong>Project Name</strong></label>

                                    <div class="col-sm-4">
										<select class="form-control m-b" id="cmbproject" name="cmbproject" onChange="ComboClick();" >
										...
										<?php
											...
											while($drow=mysqli_fetch_array($dres))
											{
												...
												if(isset($_REQUEST['cmbproject']) && $_REQUEST['cmbproject']==$drow['Id'])
					   ...
					   <br>
						   <?php
								if(isset($_REQUEST['cmbproject']) && $_REQUEST['cmbproject']<>0)
								{ ?>
						   <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
									...
									<table class="table table-striped">
										...
										<tbody>
											 <?php
												...
												if(isset($_REQUEST['cmbproject'])) 
												$sql = $sql . " and Project_Id=" . $_REQUEST['cmbproject'];
											     $sql .= " order by d.Id";
