<?php
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if($resultset)
		{
		$message = "Technology Saved Successful";
		}
		else 
		{
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="Technologies.php">
                              	 ...
                              	 <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
			  						<div class="form-group"><label class="col-sm-2 control-label">Plat Form</label>
                                    ...
                                    <div class="col-sm-4"><input type="text" class="form-control" id="txt_technologies" name="txt_technologies" placeholder="Enter Technologies" required="" value="<?php if($Id<>0) echo $row['Technologies']; ?>">
                                    </div>
                                	</div>
