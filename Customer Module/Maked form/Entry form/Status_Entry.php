                               ...
                               <?php echo $message; ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Name</label>
                                 ...
                                 <div class="form-group"><label class="col-sm-2 control-label">Remark</label>
                                    ...
                                    <div class="col-sm-1"><input type="checkbox" class="form-control"  value="True" id="txt_Isvisible" name="txt_Isvisible" placeholder="Enter Remark"></div>
                                	</div>
