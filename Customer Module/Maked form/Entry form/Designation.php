...
session_start();
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if($resultset)
		{
		$message = "Designation saved successful";
		}
		else 
		{
                            ...
                            <form method="post" class="form-horizontal" action="Designation.php">
                              ...
                              <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
                                <div class="form-group"><label class="col-sm-2 control-label">Designation </label>
                                    ...
                                    <div class="col-sm-8"><input type="text" class="form-control" id="txt_designation" name="txt_designation" placeholder="Enter Designation" required="" value="<?php if($Id<>0) echo $row['Name']; ?>"></div>
                                </div>
                                 
                                 <div class="form-group"><label class="col-sm-2 control-label">Description</label>

                                    <div class="col-sm-8"><input type="text" class="form-control" id="txt_description" name="txt_description" placeholder="Enter description" Required="" value="<?php if($Id<>0) echo $row['Remark']; ?>"></div>
                                	</div>
