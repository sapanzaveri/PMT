...
$sql= "select * from customer_master where Id='".$_SESSION['UN']."'";
...
{
$update_pwd=mysqli_query($link,"update customer_master set Password='$new_password' where Id='".$_SESSION['UN']."'");
