                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Customer Name</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="txt_name" name="txt_name" placeholder="Enter Name" ></div>
                                </div>
                                 ...
                                 <div class="form-group"><label class="col-sm-2 control-label">Remark</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="txt_remark" name="txt_remark" placeholder="Enter Remark" ></div>
                                	</div>
