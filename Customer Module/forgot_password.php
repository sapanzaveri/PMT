...
{
	//$sql = "Select u.Password,s.* from Customer_master u,staff_master s where Email='" . $_POST['txt_email'] . "' " ;
	//$sql = $sql . " and u.Staff_Id=s.Id ";
    $sql = "Select * from Customer_master  where Email='" . $_GET['txt_email'] . "' " ;
        ...
        $content =
            '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                ...
                                <form action="newpassword.php" method="get">
                                    ...
                                    <div>
                                    <a href ="http://localhost/Project%20Management%20Tool/Customer%20Module/newpassword.php?sid=' . $row['Email']. '">Click here to Change your Password</a>
                                </div>                              
                                </body>
                                </html>';
